          ...
          <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;">
            ...
            <tr align="center">
              <td style="padding: 30px; background-color:#ffffff;">
                ...
                <p style="font-size: 15px; color: #545454">Has indicado que deseas recuperar la contraseña</p>
              </td>
            </tr>
            ...
            <tr align="center">
              <td style="padding:20px; background-color:#ffffff;">
                ...
                <a href="{{url('http://' . $data['url'])}}" style="margin:0; font-size:22px; background: #4883BE; text-decoration: none; padding: 15px 15px; color: #171717; border-radius: 4px; display: inline-block;">
